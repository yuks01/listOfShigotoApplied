...
class AddShigoto{
	...
	function create(){
		$query = "INSERT INTO " . $this->table_name . " SET companyName=:companyName, position=:position, details=:details, dateApplied=:dateApplied, coverletter=:coverletter, appliedLink=:appliedLink";
